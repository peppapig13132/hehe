...
<?php } else {
	Give()->notices->print_frontend_notice( __( '[:en]You have not made any subscription donations.[:ru]У Вас нет никаких пожертвований по подписке[:es]No ha realizado ninguna donación de suscripción.[:]', 'give-recurring' ), true, 'warning' );
} ?>
